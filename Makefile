...
# Compiler flags
CXXFLAGS ?= --std=c++11 -Wall -Werror -pedantic -g -Wno-sign-compare -Wno-comment -fsanitize=address -fsanitize=undefined -fsanitize=undefined -D_GLIBCXX_DEBUG
...
sync :
  ...
  --filter=':- .gitignore' \
  ../p3-euchre/ \
  sujoysb@login.engin.umich.edu:p3-euchre-copy/